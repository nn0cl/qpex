...
- Continuous PDF / Monte Carlo — design boundary ADR 0126; strategy ADR 0162;
  **Host histogram inject MVP shipped** ADR 0163 / LISS-0195; **consumption
  ...
  provenance + Host demo). **Architecture reopen** LISS-0312 / Proposed
  [ADR 0185](docs/architecture/adr/0185-kernel-continuous-value.md) (Lane
  A finiteize surface / B mid-program Continuous / C repark — pending
  Adjudicator). **Do not start Kernel Red** until 0185 Accepted + Feature
  Plan.
