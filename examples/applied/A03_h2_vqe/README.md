...
```bash
python3 -m compiler.qpex run examples/applied/A03_h2_vqe/main_h2_vqe.qpex --seed 0
python3 -m compiler.qpex emit-qasm examples/applied/A03_h2_vqe/main_h2_vqe.qpex
```
