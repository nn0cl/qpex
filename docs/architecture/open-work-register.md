...
| Dynamic QPU lane | Phase 3 reviewed; timing Kernel slice **complete** (LISS-0381) | [LISS-0028](../issues/LISS-0028-dynamic-qpu-lane.md); ADR 0071; [ADR 0193](adr/0193-dynamic-qpu-timing-region-intent.md) (Accepted 2026-08-05); [LISS-0381](../issues/LISS-0381-dynamic-qpu-timing-region-intent.md) | Rejection/capability boundary complete. Timing intent grammar/IR (`dynamic qpu within <name>`, `TimingRegion`) shipped by LISS-0381. Lane remains unconditionally non-executable. Mid-circuit semantics and JobResult composition remain open and out of ADR 0193's scope. |
