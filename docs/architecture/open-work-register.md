...
| Observation checkpoints and execution diagnostics | Phase 2 Green | [LISS-0044](../issues/LISS-0044-observation-checkpoints-and-execution-diagnostics.md); [ADR 0089](adr/0089-observation-checkpoints-and-execution-diagnostics.md); [WP-0021](../work-plans/WP-0021-observation-checkpoints-and-execution-diagnostics.md) | Dependency-free Host observation requests/reports, simulator-only snapshot capability, no hidden measurement, and explicit resource cost are implemented; execution adapters remain deferred. |
