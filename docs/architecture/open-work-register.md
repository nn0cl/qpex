...
| Indexed operator and binder surface (final form) | LISS-0054…LISS-0057 complete; acting-space follow-up open | [ADR 0096](adr/0096-indexed-operator-and-binder-surface.md); [WP-0024](../work-plans/WP-0024-indexed-operator-and-binder-surface.md); LISS-0052…LISS-0058 | LISS-0054 ships one bracket notation `Op[i]`; LISS-0055 covers the approved executable binder slice; LISS-0056 defines empty-domain identities and was synchronized as Phase 3 complete. Its remaining empty-body/guard diagnostics are explicit follow-up gaps; general acting-space typing remains tracked by LISS-0058. LISS-0057 adds explicit periodic `wrap(i)`. |
