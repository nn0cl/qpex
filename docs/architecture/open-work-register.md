...
| Finite mathematical binder lowering | Phase 3 complete; awaiting completion review | [LISS-0052](../issues/LISS-0052-binder-lowering-execution-wiring.md); [LISS-0043](../issues/LISS-0043-finite-binder-lowering.md); [ADR 0088](adr/0088-finite-binder-lowering.md) | Inclusive finite sums retain inspection provenance and now also produce executable `OpExpr` trees consumed by the SV and QASM Hamiltonian paths. Literal indexed Pauli sites are supported wherever site-qualified Pauli operators are valid. The broader binder body and composition surface remains sequenced under [ADR 0096](adr/0096-indexed-operator-and-binder-surface.md) and [WP-0024](../work-plans/WP-0024-indexed-operator-and-binder-surface.md). |
