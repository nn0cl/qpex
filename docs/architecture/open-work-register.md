...
|---|---|---|---|
| Ideal v1 language and compiler | **Accepted with conditions** | [ADR 0106](adr/0106-staqex-v1-north-star-language-and-compiler.md); [LISS-0068](documentation-compression-map.md); [WP-0025](../work-plans/WP-0025-staqex-v1-north-star.md); [rebaseline register](../specs/staqex-v1-normative-rebaseline-register.md) | North-star target architecture accepted 2026-07-27. LISS-0068 slice 2 may proceed; implementation remains per-Issue gated.
...
| Kernel classical boundary / static `forEach` | Historical slice complete; superseded surface tracked | [LISS-0026](documentation-compression-map.md); [ADR 0069](adr/0069-kernel-static-hilbert-space.md) | Static elaboration remains shipped; normative `QubitRegister<N>` migration/resource boundary is complete in LISS-0029. |
...
| `evolve ... until` | **Runtime complete** | [LISS-0012](documentation-compression-map.md); [ADR 0079](adr/0079-evolve-until-kernel-semantics.md) | Bounded pure repetition in the Joint evaluator; QPU emission remains unsupported. |
...
| Binder endpoints / `where \|\|` / `rev` | **complete** (WP-0034) | [WP-0034](documentation-compression-map.md); [ADR 0117](adr/0117-binder-index-endpoints-and-rev.md); LISS-0145–0147 | Static additive Index endpoints, dependent ranges, `rev(D)`, binder `\|\|`. |
| Basis binder / partial Float | **complete** (WP-0035) | [WP-0035](documentation-compression-map.md); [ADR 0118](adr/0118-basis-binder-and-partial-float.md); LISS-0148–0149 | `Basis<N>` expansion; classical `Float[M…] row = h[i]`. |
...
| Linear verifier hardening / residual risks | **complete** | [LISS-0114](documentation-compression-map.md), [ADR 0107](adr/0107-linear-uncompute-amplitude-tolerance.md) (**Accepted**) | A–F complete; runtime ≈\|0⟩ tol 1e-12 locked by ADR 0107. |
...
| Numeric literal separators | Phase 3 Refactor complete | [LISS-0061](documentation-compression-map.md); [ADR 0101](adr/0101-numeric-literal-separators.md) | Java-compatible placement between digits is implemented; leading-underscore private identifiers remain unchanged; formatter and QPU provenance remain deferred. |
