...
| Observation checkpoints and execution diagnostics | Phase 1 Red | [LISS-0044](../issues/LISS-0044-observation-checkpoints-and-execution-diagnostics.md); [ADR 0089](adr/0089-observation-checkpoints-and-execution-diagnostics.md); [WP-0021](../work-plans/WP-0021-observation-checkpoints-and-execution-diagnostics.md) | Contract tests define portable reports, explicit simulator-only snapshots, no hidden measurement, and explicit resource cost; production implementation remains deferred. |
