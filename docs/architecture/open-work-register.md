...
| Scientific input and parameter binding | Phase 1 Red | [LISS-0045](../issues/LISS-0045-scientific-input-and-parameter-binding.md); [ADR 0090](adr/0090-scientific-input-and-parameter-binding.md); [WP-0020](../work-plans/WP-0020-scientific-input-and-parameter-binding.md) | Scalar Host-owned input, `Param<T>` bindings, immutable sweeps, result opacity, and provenance contract tests; production implementation/provider SDKs remain deferred. |
