...
| Local observation plan execution | Phase 1 Red | [LISS-0047](../issues/LISS-0047-local-observation-plan-execution.md); [ADR 0092](adr/0092-local-observation-plan-execution.md); [WP-0023](../work-plans/WP-0023-local-observation-plan-execution.md) | Contract tests define opaque HostExecutionContext, deterministic fake source, portable reports, cost-only separate jobs, and hard unsupported-projection diagnostics; Green implementation remains deferred. |
