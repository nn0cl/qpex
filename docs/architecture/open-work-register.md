...
| Hybrid scientific workflow | Proposed | [LISS-0035](../issues/LISS-0035-hybrid-scientific-workflow.md) | VQE/QAOA-like host workflow extends Job/Task boundaries; no provider SDK. |
