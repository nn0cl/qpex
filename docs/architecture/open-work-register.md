...
| Indexed operator and binder surface (final form) | LISS-0054 complete; follow-ups open | [ADR 0096](adr/0096-indexed-operator-and-binder-surface.md); [WP-0024](../work-plans/WP-0024-indexed-operator-and-binder-surface.md); LISS-0052…LISS-0057 | LISS-0054 ships one bracket notation `Op[i]` and migrates the operator consumers. Binder-body generalization, empty domains, periodic accessors, and acting-space typing remain tracked by LISS-0055…LISS-0058. |
