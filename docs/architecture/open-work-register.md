...
| Local observation plan execution | Phase 0 Design Intake | [LISS-0047](../issues/LISS-0047-local-observation-plan-execution.md); [ADR 0092](adr/0092-local-observation-plan-execution.md); [WP-0023](../work-plans/WP-0023-local-observation-plan-execution.md) | Proposed local ObservationExecutionPort and deterministic fake/simulator adapter for portable reports; provider/QPU execution, snapshots, and partial reports remain deferred. |
