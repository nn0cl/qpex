...
| Finite mathematical binder lowering | Phase 2 Green | [LISS-0043](../issues/LISS-0043-finite-binder-lowering.md); [ADR 0088](adr/0088-finite-binder-lowering.md) | Inclusive Open ranges lower the restricted Pauli nearest-neighbor sum with diagnostics, resource guard, and provenance; periodic/product/general operators remain deferred. |
