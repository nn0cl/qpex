...
| Hybrid scientific workflow | Phase 4 Design Proposed | [LISS-0035](../issues/LISS-0035-hybrid-scientific-workflow.md), [ADR 0072](adr/0072-hybrid-workflow-host-contract.md), [ADR 0073](adr/0073-declarative-workflow-surface.md) | Immutable provider-neutral Workflow/Job DTO boundary; declarative surface proposed, no provider SDK. |
| Continuous operators and discretization | Proposed | [LISS-0036](../issues/LISS-0036-continuous-operator-and-discretization-boundary.md) | No hidden discretization; depends on numerical representation. |
