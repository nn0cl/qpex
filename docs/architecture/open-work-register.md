...
| Observation checkpoints and execution diagnostics | Phase 0 Design Intake | [LISS-0044](../issues/LISS-0044-observation-checkpoints-and-execution-diagnostics.md); [ADR 0089](adr/0089-observation-checkpoints-and-execution-diagnostics.md); [WP-0021](../work-plans/WP-0021-observation-checkpoints-and-execution-diagnostics.md) | Proposed Host/workflow observation plans, portable reports, explicit simulator-only snapshots, and no hidden measurement; Phase 1 Red awaits review. |
