...
| Scientific input and parameter binding | Proposed | [LISS-0045](../issues/LISS-0045-scientific-input-and-parameter-binding.md); [ADR 0090](adr/0090-scientific-input-and-parameter-binding.md) | Host-owned typed data contracts, parameter sweeps, result envelopes, and provenance; file formats/provider SDKs remain adapters. |
