...
| Field | Value |
|---|---|
| Status | **Slice B Phase 2 Green** (2026-07-28); catalog published |
...
| **B** | Versioned claim→scenario catalog (E-envelope × taxonomy × SV id; deferrals explicit) | **Phase 2 Green** |
