...
| Continuous PDF / Monte Carlo | permanent-out → **Lane A shipped** | ADR 0126 mid-program Continuous still out; Host inject 0163/0164; notebook `finiteize` [ADR 0185](../architecture/decision-themes/dec-0004-type-first-scientific-model.md) / [LISS-0313](../architecture/documentation-compression-map.md) **complete** |
