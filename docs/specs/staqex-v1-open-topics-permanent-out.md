...
| Continuous PDF / Monte Carlo | permanent-out → **Architecture reopen** | ADR 0126/0162 maintained; Host inject **shipped** 0163/0164; Kernel surface Proposed [ADR 0185](../architecture/adr/0185-kernel-continuous-value.md) / [LISS-0312](../issues/LISS-0312-continuous-kernel-architecture.md) (lane A/B/C pending Accept) |
