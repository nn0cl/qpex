...
| Topic | Was | Now |
|---|---|---|
| Further `\|>` / currying (fusion, partial-app values) | no-further-ship | **partial shipped** — unary/Partial/stepwise/hole-fill + thin Operator Fusion MVP (ADR 0137) + Trace-Out GC fn-scope (ADR 0138); prune/deferred DAG still Hold |
