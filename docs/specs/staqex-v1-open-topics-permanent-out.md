...
| Topic | Was | Now |
|---|---|---|
| Further `\|>` / currying (fusion, partial-app values) | no-further-ship | **partial shipped** — unary/Partial + ADR 0022 MVPs + affine (0141) + Call/Partial Fusion (0143); multi-hole / poly≥2 / GPU DAG later |
