...
| Topic | Was | Now |
|---|---|---|
| Further `\|>` / currying (fusion, partial-app values) | no-further-ship | **partial shipped** — unary/Partial/stepwise/hole-fill + Operator Fusion (ADR 0137) + Trace-Out GC (ADR 0138) + Interference prune (ADR 0139); deferred DAG still Hold |
