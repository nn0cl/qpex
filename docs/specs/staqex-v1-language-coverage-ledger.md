...
| Further `\|>` / currying | **partial** | Unary bare / Partial / hole-fill shipped; Operator Fusion (ADR 0137); Trace-Out GC (ADR 0138); Interference prune (ADR 0139); deferred DAG still Hold |
