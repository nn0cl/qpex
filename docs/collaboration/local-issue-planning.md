...
| LISS-0082 | Quantum Semantic IR | **review**; exclusive writes `quantum_semantic_ir.py`, `tests/test_quantum_semantic_ir_*.py`; Slice A complete, Slice B **not complete** (follow-up 1 closed gaps 1/2/5, gap 4 decided; gap 3 Green complete and Refactor gated), Slice C gated |
