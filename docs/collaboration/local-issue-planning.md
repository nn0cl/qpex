...
| LISS-0082 | Quantum Semantic IR | **review**; exclusive writes `quantum_semantic_ir.py`, `tests/test_quantum_semantic_ir_*.py`; Slice A complete, Slice B **not complete** (approved Red scope shipped; 5 laws unverified), Slice C gated |
