...
| LISS-0082 | Quantum Semantic IR | **review**; exclusive writes `quantum_semantic_ir.py`, `tests/test_quantum_semantic_ir_*.py`; Slice A complete, Slice B Phase 1 Red complete, Slice B Green gated |
