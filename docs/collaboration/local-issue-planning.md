...
| LISS-0082 | Quantum Semantic IR | **review**; exclusive writes `quantum_semantic_ir.py`, `tests/test_quantum_semantic_ir_*.py`; Slices A and B complete, final Slice B review and push/PR/merge gated, Slice C separately gated |
