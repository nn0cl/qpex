...
| LISS-0099 | Target capability profile and physical target port | **complete** — integrated package; `target_capability.py`; branch `feature/liss-0099-target-capability` pending merge |
