...
- Specifications and files inspected: `docs/issues/LISS-0072-lossless-cst-formatter-and-source-versioning.md`;
  `docs/specs/qpex-v1-cst-formatter-plan.md`; `tests/test_versioning_slice_c_red.py`;
  `compiler/qpex/parser.py`; `compiler/qpex/ast_nodes.py`; `compiler/qpex/pipeline.py`.
- Component boundaries: package metadata parsing only; no formatter or EBNF
  work in this phase.
- Applicable constraints: `qpex_version` remains accept/reject metadata, not a
...
- `compiler/qpex/ast_nodes.py`
- `compiler/qpex/pipeline.py`
