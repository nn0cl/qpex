...
- Date: 2026-07-28
- Task: Promote E0 artifacts into `qpex-language-specification.md` v1.0
- Agent: Cursor (Auto)
...
- `docs/specs/qpex-language-specification.md` → **Normative v1.0**
...
- `docs/testing/qpex-spec-verification-protocol.md` header synced to v1.0
